...
public:
	...
	public:
		...
		constexpr Color(unsigned char r, unsigned char g, unsigned char b) noexcept
			...
			dword((r << 16u) | (g << 8u) | b)
		{}
		const Color(Color col, unsigned char x) noexcept
			:
		...
		void SetR(const unsigned char r) noexcept
		{
			dword = (dword & 0xFF00FFFFu) | (r << 16u);
		}
		void SetG(const unsigned char g) noexcept
		{
			dword = (dword & 0xFFFF00FFu) | (g << 8u);
		}
		void SetB(const unsigned char b) noexcept
		{
